...
import { FaFlag, FaClock, FaMapMarkerAlt, FaInfoCircle, FaTrash } from 'react-icons/fa';

const CarpoolDetails = ({ isOpen, onClose, activity, carpool, handleRemoveFromCarpool }) => {
